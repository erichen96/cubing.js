...
var cube2x2x2 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).cube2x2x2JSON
    )
  ),
  svg: async () => (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).cube2x2x2SVG,
  llSVG: getCached(
    async () => (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).cube2x2x2LLSVG
  ),
  pg: getCached(async () => {
...
var clock = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).clockJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).clockSVG;
  })
};
...
var PyraminxPuzzleLoader = class extends PGPuzzleLoader {
  constructor() {
    ...
    this.svg = getCached(async () => {
      return (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).pyraminxSVG;
    });
  }
};
...
var square1 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).sq1HyperOrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).sq1HyperOrbitSVG;
  })
};
...
var melindas2x2x2x2 = {
  ...
  kpuzzle: getCached(
    async () => new KPuzzle(
      (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).melindas2x2x2x2OrbitJSON
    )
  ),
  svg: getCached(async () => {
    return (await import("./puzzles-dynamic-side-events-SRPR4BEO.js")).melindas2x2x2x2OrbitSVG;
  })
};
...
//# sourceMappingURL=chunk-3AOSWXBV.js.map
